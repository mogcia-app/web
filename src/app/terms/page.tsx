...
export const metadata: Metadata = {
  title: '利用規約 | 株式会社MOGCIA',
  description: '株式会社MOGCIAの利用規約についてご説明いたします。',
};
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-8">
                この利用規約（以下「本規約」）は、株式会社MOGCIA（以下「当社」）が提供するサービス（以下「本サービス」）の利用条件を定めるものです。お客様には、本規約に従って本サービスをご利用いただきます。
              </p>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">第3条（サービス内容）</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
                  当社は、以下のサービスを提供いたします：
                </p>
                <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                  ...
                  <li>モバイル対応</li>
                  <li>SEO対策</li>
                  <li>その他、WEB制作に関するサービス</li>
                </ul>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">第4条（利用料金および支払方法）</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">第6条（本サービスの提供の停止等）</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  お客様と当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は、お客様から、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時に当社からお客様へ到達したものとみなします。
                </p>
              </section>
